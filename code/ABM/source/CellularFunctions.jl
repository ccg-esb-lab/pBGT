...
@everywhere function plasmids_dynamics(b::Bacteria) 
    ...
    pC=b.plasmids[1]    #Bacteria expected plasmid copy number (mu)
    pC<0 ? pC=0 : 0
...
@everywhere function antibiotic_dynamics(b::Bacteria,aA::Float64)
    ...
    rA=0.;
    rA=mA*pA+bA     # Resistance to antibiotic A by plasmid A
    ...
    sA=aA/rA        #Succeptibility to antibiotic A
...
@everywhere function grow(b::Bacteria, R,aA)     
    ...
    modC<0 ? modC=0 : 0
    #print(modC," ",cE*modC," ",b.gparams[1])
    
    
    c=cE*modC  #Efficiency
    #c=b.gparams[1]  #This bacteria efficiency
